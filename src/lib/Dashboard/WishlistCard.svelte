...
<div class="mx- my-">
	<div
		class="relative mx-auto flex  flex-col justify-center bg-white rounded-2xl shadow-xl shadow-slate-300/60 space-x-4"
	>
		<!-- img -->
		<img
			class="aspect-video  rounded-t-2xl object-cover object-center"
			src="/images/hero.jpg"
			alt=""
		/>
		<div
			class="absolute  top-3 right-5 bg-white rounded-full py-2 px-2 shadow-lg"
			on:click={() => removeWish(wishItem.publickKey)}
		>
