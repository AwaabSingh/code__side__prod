						...
						<div class="flex -mx-3">
							<div class="w-full px-3 mb-5">
								<button
									...
									disabled={isEmpty}
									class:disabled={isEmpty}>REGISTER NOW</button
								>
							</div>
						</div>
						<div class="flex -mx-3">
							<div class="w-full px-3 mb-5">
								<p class="text-center pt-5 text-black">
									By signing up, you agree to our <span class="text-lgPur">
						...
						<div class="flex -mx-3">
							<div class="w-full px-3 mb-5">
								<p class="text-center  text-black">
									Have an Account ? <a href="/login" class="text-lgPur font-bold"> Login</a>
								</p>
							</div>
						</div>
					</form>
