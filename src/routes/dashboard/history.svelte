		...
		<table class="sm:table-fixed w-full divide-y font-medium">
			<thead>
				<tr>
					...
					<th class="w-1/6 py-3 whitespace-nowrap" />
				</tr>
			</thead>
			<tbody class="divide-y">
				<tr>
					...
					<td class="whitespace-nowrap py-4"
						><span>2021-05-14 <span class="md:inline hidden"> 12:31:34 </span></span></td
					>
					<td class="whitespace-nowrap py-4 text-right"
						><span class="bg-red-100 text-red-600 font-semibold px-3 py-1 rounded-full text-sm"
							>Not Paid</span
						></td
					>
				...
				<tr>
					...
					<td class="whitespace-nowrap py-4 text-right"
						><span
							class="bg-yellow-100 text-yellow-600 font-semibold px-3 py-1 rounded-full text-sm"
							>Pending</span
						></td
					>
				...
				<tr>
					...
					>
					<td class="whitespace-nowrap py-4 text-right"
						><span class="bg-green-100 text-green-600 font-semibold px-3 py-1 rounded-full text-sm"
							>Success</span
						></td
					>
